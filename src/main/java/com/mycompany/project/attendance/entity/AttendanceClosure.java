...
public class AttendanceClosure {
    ...
    /** 선택 조건(학년/반/강좌) - null이면 전체 범위를 의미 */
     ...
     */
    public AttendanceClosure(Long academicYearId, ScopeType scopeType, String scopeValue,
                             Integer grade, Integer classNo, Long courseId, Long userId) {
