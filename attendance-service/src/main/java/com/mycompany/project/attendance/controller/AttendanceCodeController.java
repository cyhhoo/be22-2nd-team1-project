...
@RequestMapping("/api/v1/attendance/codes") // 이 컨트롤러의 공통 URL 시작 경로
public class AttendanceCodeController {
    ...
    @GetMapping("/{attendanceCodeId}") // GET /api/v1/attendance/codes/{attendanceCodeId}
    ...
    @GetMapping // GET /api/v1/attendance/codes
    ...
    public ResponseEntity<ApiResponse<List<AttendanceCodeResponse>>> findAll(@RequestParam(required = false) Boolean activeOnly) {
        ...
        // 예: /api/v1/attendance/codes?activeOnly=true
