...
INSERT INTO tbl_user (user_id, email, password, name, role, status, birth_date, login_fail_count, created_at, updated_at)
VALUES
    (1002, 'teacher2@schoolmate.local', '$2y$10$HND8tKCP8KcjTUCpcsFGae2Y7LrP2zvu43majP5r1oBhN4csqFRhu', 'Teacher two', 'TEACHER', 'ACTIVE', '1995-02-01', 0, NOW(), NOW());
