...
-- [시나리오 1용] 정상 과목 2개
INSERT INTO tbl_course (course_id, name, max_capacity, current_count, tuition, course_type, status, teacher_detail_id, created_at) VALUES (101, '자료구조', 30, 0, 50000, 'MANDATORY', 'OPEN', 3, DATE(NOW()));
INSERT INTO tbl_course (course_id, name, max_capacity, current_count, tuition, course_type, status, teacher_detail_id) VALUES (102, '운영체제', 30, 0, 50000, 'MANDATORY', 'OPEN', 3);

-- [시나리오 2용] 만석 과목 1개, 여유 과목 1개
INSERT INTO tbl_course (course_id, name, max_capacity, current_count, tuition, course_type, status, teacher_detail_id) VALUES (201, '인기교양(만석)', 10, 10, 30000, 'ELECTIVE', 'OPEN', 3);
INSERT INTO tbl_course (course_id, name, max_capacity, current_count, tuition, course_type, status, teacher_detail_id) VALUES (202, '일반교양(여유)', 30, 5, 30000, 'ELECTIVE', 'OPEN', 3);

-- [시나리오 3용] 이미 수강 중인 과목 (재신청 테스트용)
INSERT INTO tbl_course (course_id, name, max_capacity, current_count, tuition, course_type, status, teacher_detail_id) VALUES (301, '이미듣는수업', 30, 1, 50000, 'MANDATORY', 'OPEN', 3);
